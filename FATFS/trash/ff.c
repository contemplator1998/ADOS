...
FRESULT f_read (
	FIL *fp, 		/* Pointer to the file object */
	void *buff,		/* Pointer to data buffer */			  //куда считывать
	UINT btr,		/* Number of bytes to read */			  //сколько надо считать из файла
	UINT *br		/* Pointer to number of bytes read */	 //сколько считали из файла (по факту)
)
{
	FRESULT res;
...
FRESULT f_write (
	FIL *fp,			/* Pointer to the file object */
	const void *buff,	/* Pointer to the data to be written */		 //откуда пишем в файл
	UINT btw,			/* Number of bytes to write */				 //кол-во символов для записи
	UINT *bw			/* Pointer to number of bytes written */	//сколько записали в файл (равно "Number of bytes to write")
)
{
	FRESULT res;
	DWORD clst, sect;
